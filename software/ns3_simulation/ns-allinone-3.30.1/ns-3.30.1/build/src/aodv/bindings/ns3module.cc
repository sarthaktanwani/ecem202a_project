...
PyObject *
_wrap_PyNs3AodvRoutingProtocol_GetDestinationOnlyFlag(PyNs3AodvRoutingProtocol *self)
{
    PyObject *py_retval;
    bool retval;
...
PyObject *
_wrap_PyNs3AodvRreqHeader_GetGratuitousRrep(PyNs3AodvRreqHeader *self)
{
    PyObject *py_retval;
    bool retval;
