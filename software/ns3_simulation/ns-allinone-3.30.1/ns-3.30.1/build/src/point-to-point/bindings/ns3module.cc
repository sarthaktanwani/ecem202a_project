...
PyObject *
PyNs3PointToPointNetDevice__PythonHelper::_wrap_DoInitialize(PyNs3PointToPointNetDevice *self)
{
    PyObject *py_retval;
    PyNs3PointToPointNetDevice__PythonHelper *helper = dynamic_cast< PyNs3PointToPointNetDevice__PythonHelper* >(self->obj);
...
bool
PyNs3PointToPointRemoteChannel__PythonHelper::TransmitStart(ns3::Ptr< ns3::Packet const > p, ns3::Ptr< ns3::PointToPointNetDevice > src, ns3::Time txTime)
{
    PyGILState_STATE __py_gil_state;
    PyObject *py_method;
...
ns3::Ptr< ns3::NetDevice >
PyNs3PointToPointRemoteChannel__PythonHelper::GetDevice(std::size_t i) const
{
    PyGILState_STATE __py_gil_state;
    PyObject *py_method;
    ns3::PointToPointChannel *self_obj_before;
